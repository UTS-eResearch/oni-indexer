...
class CatalogSolr {
  ...
  // TODO = setConfig needs to return the facets and schema
...
Types with errors: ${this.errors.join(', ')}`);
  ...
  schema() {
    // TODO: generate the schema json based on the index config
    // main things this has to do - what goes into the main search
    // and what needs overriding - like dates which Solr doesn't like
  }
